...
export function HomeFinalCtaSection() {
  const mainImage = SITE_IMAGES.damLiners;
  const tankImage = SITE_IMAGES.steelTank;
  const waterproofingImage = SITE_IMAGES.bitumen;

  return (
    <section
      className="home-final-cta"
      aria-labelledby="damtech-final-quote-heading"
    >
      <div className="home-final-cta__inner">
        <div className="home-final-cta__card">
          <div className="home-final-cta__grid">
            <div className="home-final-cta__copy">
              <div className="home-final-cta__eyebrow-wrap">
                <p className="home-final-cta__eyebrow">READY TO GET STARTED?</p>
                <span className="home-final-cta__eyebrow-accent" aria-hidden />
              </div>

              <h2 id="damtech-final-quote-heading" className="home-final-cta__title">
                Request a FREE Quote
              </h2>

              <p className="home-final-cta__intro">
                Whether you need dam linings, waterproofing, steel water tanks or
                maintenance, our team is ready to help with a practical, tailored
                solution for farms, mines, game lodges and commercial properties
                across South Africa.
              </p>
            ...
            <div
              className="home-final-cta__media"
              aria-label="Damtech services image collage"
            >
              <div className="home-final-cta__collage">
                <figure className="home-final-cta__collage-main">
                  <Image
                    src={mainImage.image}
                    alt="HDPE dam lining and water storage project by Damtech"
                    fill
                    loading="lazy"
                    sizes="(max-width: 1023px) 88vw, 420px"
                    placeholder="blur"
                    className="home-final-cta__collage-img"
                  />
                </figure>

                <figure className="home-final-cta__collage-small home-final-cta__collage-small--top">
                  <Image
                    src={tankImage.image}
                    alt="Corrugated steel water tank for farm and commercial water storage"
                    fill
                    loading="lazy"
                    sizes="(max-width: 1023px) 42vw, 200px"
                    placeholder="blur"
                    className="home-final-cta__collage-img"
                  />
                </figure>

                <figure className="home-final-cta__collage-small home-final-cta__collage-small--bottom">
                  <Image
                    src={waterproofingImage.image}
                    alt="Bitumen torch-on waterproofing work for leak prevention"
                    fill
                    loading="lazy"
                    sizes="(max-width: 1023px) 42vw, 200px"
                    placeholder="blur"
