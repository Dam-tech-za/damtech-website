...
export function CalculatorResultsPanel({
  ...
  if (!calculatorType && !inputs && !results) {
    return (
      <AdminPanel title="Calculator results">
        <AdminEmptyState title="No calculator data on this RFQ." />
      </AdminPanel>
    );
  }
  ...
  return (
    <AdminPanel
      ...
      description={calculatorType ?? "Unknown calculator"}
    >
      {isHdpe ? (
        <AdminTable caption="HDPE calculator results">
          <tbody>
            {renderRows(inputs, [
      ...
      {isWater ? (
        <AdminTable caption="Water calculator results">
          <tbody>
            {renderRows(inputs, [
      ...
      {!isHdpe && !isWater ? (
        <AdminTable caption="Calculator inputs and results">
          <thead>
            <tr>
              <th>Field</th>
              <th>Value</th>
