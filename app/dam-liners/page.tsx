...
import {
  LazyBenefitCardGrid as BenefitCardGrid,
  LazyComparisonTable as ComparisonTable,
  LazyCTA as CTA,
  LazyInfoCardGrid as InfoCardGrid,
  LazyInternalServiceLinks as InternalServiceLinks,
  LazyProcessStepsSection as ProcessStepsSection,
  LazyProjectProofStrip as ProjectProofStrip,
  LazyRelatedPageLinks as RelatedPageLinks,
  LazySectionCta as SectionCta,
  LazyServiceFaqSection as ServiceFaqSection,
  LazyServiceIntroSection as ServiceIntroSection,
  LazyServiceProseSections as ServiceProseSections,
